...
def fetch_extended_data(symbol="PEPEUSDT", interval="1m", total_candles=2000, custom_end_time=None):
    """
...
def run_evolution(generations=1000, population_size=10, candles_limit=2000): 
    ...
    for gen in range(generations):
        ...
        print(f"🏆 MEJOR DE GEN {gen}: Balance ${gen_best_fitness:.2f} | Neuronas: {len(gen_best_genome)}")
        ...
        if gen_best_fitness > best_global_fitness:
            ...
            np.save("best_genome_EVO_PLASTIC.npy", np.array(best_global_genome))
...
if __name__ == "__main__":
    ...
    winner_genome = run_evolution(generations=1000, population_size=50, candles_limit=2000)
