...
class NeuroPlasticBrain:
    ...
    def _structural_plasticity(self):
        ...
        for i in range(len(self.genome)):
            ...
            # AHORA CONTROLADO POR EL SWITCH ENABLE_APOPTOSIS
            if ENABLE_APOPTOSIS and energy <= 0 and len(self.genome) - dead_count > self.MIN_NEURONS:
                dead_count += 1
...
def run_evolution(generations=10, population_size=10, candles_limit=5000): 
    ...
    for gen in range(generations):
        ...
        is_disaster = False
        if best_global_genome is not None:
             ratio_fitness = 0
...
if __name__ == "__main__":
    ...
    winner_genome = run_evolution(generations=1000, population_size=50, candles_limit=20000)
