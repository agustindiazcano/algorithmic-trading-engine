...
class DynamicCausalBrain:
    ...
    def predict(self, points):
        ...
        # Activación Plateau (Detección de forma sólida)
...
def fetch_extended_data(symbol="PEPEUSDT", interval="5m", total_candles=5000):
    """
...
def run_evolution(generations=10000): # Poner 10000+ para serio
    print(f"💀 INICIANDO SIMULACIÓN CON DATOS REALES")
    
    # 1. Bajamos la realidad
    market_prices, market_vols, market_volatilities = fetch_extended_data("PEPEUSDT", "5m", 5000)
    ...
    LEVERAGE = 30.0       # Simulamos Spot/x1 primero. Si gana acá, gana en x50.
