...
def fetch_extended_data(symbol="PEPEUSDT", interval="1m", total_candles=5000, custom_end_time=None):
    ...
    all_closes, all_volumes, all_highs, all_lows, all_opens = [], [], [], [], []
...
def run_evolution(generations=100000, population_size=10): # <-- Population Size
    ...
    return best_genome, best_threshold, prices_aligned, vols_aligned, inputs
...
if __name__ == "__main__":
    ...
    winner, winner_thr, prices, vols, inputs = run_evolution(generations=100)
    ...
    if winner is not None:
        ...
        for i in range(1, 11):
            ...
            try:
                ...
                t_prices, t_vols, t_volats = fetch_extended_data("PEPEUSDT", "1m", total_candles=len(prices), custom_end_time=random_time)
