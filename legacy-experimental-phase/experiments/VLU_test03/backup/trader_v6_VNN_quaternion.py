...
TRADING_MODE = "SHORT"  # Opciones: "LONG", "SHORT", "BOTH"
...
class QuaternionNeuron3D:
    ...
    def __init__(self, genome_slice):
        ...
        # Memoria Bayesiana
        # FIX B: Confianza inicial alta (Beneficio de la duda)
        self.alpha = 5.0
        self.beta = 1.0
        self.confidence = 0.5
...
class QuaternionBrain:
    def __init__(self, n_neurons=10):
        ...
        # Gen de personalidad
        # FIX A: Umbral más bajo para fomentar operación temprana
        self.decision_threshold = np.random.uniform(0.1, 0.4)
...
def run_evolution(generations=10, population_size=1):
    ...
    for gen in range(generations):
        ...
        for i in range(population_size):
            ...
            # FIX C: Penalizar inactividad (Muerte por aburrimiento)
            elif trades < 5: fitness = balance * 0.1 
